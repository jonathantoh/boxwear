    ...
    <table class="auto-style2">
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="tb_ProductID" placeholder="Eg: 'anything' - M" runat="server"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:TextBox ID="tb_ProductName" placeholder="Eg: Women/Men shirt" runat="server"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:DropDownList ID="ddl_ProdCat" runat="server">
                    ...
                    <asp:ListItem Text="Shoes" Value="3"></asp:ListItem>
        ...
        <tr>
            ...
            <td class="auto-style10">
                <asp:TextBox ID="tb_UnitPrice" placeholder="Eg: 40" runat="server"></asp:TextBox>
            </td>
            <td class="auto-style11">
                <asp:RequiredFieldValidator ID="rfc_UnitPrice" runat="server" ErrorMessage="Please enter a Unit Price for the product." ControlToValidate="tb_UnitPrice" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="tb_StockQuantity" placeholder="Eg: 150" runat="server"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="rfv_StockQuantity" runat="server" ControlToValidate="tb_StockQuantity" ErrorMessage="Please enter a value for the Stock Quantity." ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
