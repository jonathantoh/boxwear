...
public class ShoppingCart
{
    ...
    public ShoppingCartItem getAShoppingCartItem(string ProductID)
    {
    ...
    public void AddItem(string ProductID, Products prod)
    {
    ...
    {
        Items.Remove(ShoppingCart.Instance.getAShoppingCartItem(ProductID));
    }
